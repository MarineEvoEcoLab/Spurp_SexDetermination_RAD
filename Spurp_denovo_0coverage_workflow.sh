...
# ~~~~~~~~~~~~~~~
# DE-NOVO CONSTRUCTION ON PROCESSED READW
# ~~~~~~~~~~~~~~~
...
rainbow cluster -1 $bigfile1 -2 $bigfile2 -m 4 -e 2000 > rbcluster.out 2> rbcluster.log

rainbow div -i rbcluster.out -o rbdiv.out -k 7 -K 10 -f .5 2> rbdiv.log

rainbow merge -i rbdiv.out -o rbmerge.out -a -r 2 -N1000 -R1000 -l 20 -f .9 2> rbmerge.log
